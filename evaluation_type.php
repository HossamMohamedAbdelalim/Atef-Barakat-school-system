...
class evaluation_type
{
    ...
    function __construct($id)
    {
        ...
        if($id !="")
        {
            $sql="select * from   evaluation_type   where id = $id";
    ...
    public function creat()
    {
       ...
       $sql = "INSERT INTO  evaluation_type ('name') VALUES ('$name')  ";
    ...
    public function update()
    {
       ...
       $sql = "UPDATE  evaluation_type SET 'name' = $name, 'id' = $id   ";
    ...
    public function delete()
    {
       ...
       $sql = "DELETE  FROM  evaluation_type  WHERE 'id' = '$evaluation_type_id'";
